...
def sort_XyZ(X,y,Z):
  ...
  Z = Z[indices]
  return X,y,Z 
def supervised_kernel(X,y,n_estimators=100, plot=True, scaler=True, Z=None):
	...
	Z_train, Z_test,  y_train, y_test, = train_test_split( Z,y, test_size=0.2, random_state=43) 
