...
python tuning.py  --modality PET --version 3 \
            --kernel_type rbf \
            --epochs 30000 --dropout_rate 0.1 --patience 3000 \
...
python tuning.py  --modality PET --version 4 \
            --kernel_type rbf \
            --epochs 30000 --dropout_rate 0.1 --patience 5000 \
            --batch_size 64 --lr 1e-4 --lambda_ 0.75 \
            --hidden_dims 1000 60 \
            --latent_dim 30 
...
#             --batch_size 64 --lr 1e-4 --lambda_ 0.9 \
#             --hidden_dims 1000 60 \
#             --latent_dim 30 
...
#             --kernel_type rbf \
#             --epochs 1000 --dropout_rate 0.1 --patience 200 \
#             --batch_size 32 --lr 1e-4 --lambda_ 0.95 \
#             --hidden_dims 1000 60\
#             --latent_dim 30 \
